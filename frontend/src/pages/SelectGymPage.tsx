    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh]">
                ...
                <Button variant="outline" onClick={() => navigate('/')} className="cursor-pointer">Powrót</Button>
            </div>
        );
    }
                ...
                {gyms.map((gym) => (
                    <Card key={gym.id} className="w-64 h-32 bg-black border border-zinc-800 rounded-3xl">
                        ...
                        <div className="flex justify-center">
                            <Button asChild variant="outline" className="cursor-pointer text-xs hover:bg-zinc-800">
