...
export default function TrainerSchedulePage() {
  ...
  useEffect(() => {
    ...
    Object.entries(daysMap).forEach(([day]) => {
        ...
        const slots = (schedule[dayNum] || []).sort(
  ...
  const weekDiff =
    (weekStart.getTime() - todayStart.getTime()) /
    (7 * 24 * 60 * 60 * 1000)
    ...
    <div className="flex flex-col items-center min-h-[80vh] p-4">
        ...
        <CardHeader className="pt-5 space-y-5">
            ...
            <div className="text-center">
                ...
                Wybierz dostępny termin u trenera
                </p>
            </div>
        ...
        s => s.available && !isPastSlot(date, s.startHour)
            ...
            >
                ...
                <div className="space-y-2">
                    ...
                    const disabled =
                        !slot.available ||
                        isPastSlot(date, slot.startHour)
                    ...
                    return (
                        ...
                        >
                            {booking === bookingKey ? "Rezerwuję..." : disabled ? "Niedostępne" : "Rezerwuj"}
                        </Button>
                        </div>
                    )
                    })}
